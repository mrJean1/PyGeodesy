...
# Tested with Python 2.7.10, 3.5.2 and 3.6.0 but only on MacOS
# 10.10 Mavericks and 10.11 El Capitan.
...
# tests/run.py /usr/local/bin/python3.5 all OK (Python 3.5.2)
...
# tests/run.py /usr/local/bin/python3.6 all OK (Python 3.6.0)

# % python3 tests/run.py -h
# usage: tests/run.py [-failedonly] [-verbose] [tests/test...py ...]

# % python3 tests/run.py -f
# tests/run.py /usr/local/bin/python3 tests/testBases.py
    # all geodesy.bases tests passed (Python 3.6.0)

# tests/run.py /usr/local/bin/python3 tests/testDatum.py
    # all geodesy.datum tests passed (Python 3.6.0)

# tests/run.py /usr/local/bin/python3 tests/testDms.py
    # all geodesy.dms tests passed (Python 3.6.0)

# tests/run.py /usr/local/bin/python3 tests/testEllipsoidal.py
    # all ellipsoidalNvector tests passed (Python 3.6.0)
    # all ellipsoidalVincenty tests passed (Python 3.6.0)
...
# tests/run.py /usr/local/bin/python3 tests/testGreatCircle.py
    ...
    # 5 sphericalNvector tests (17.2%) FAILED, incl. 5 KNOWN (Python 3.6.0)
    # test 7 DistanceEiffelToVersailles: 14084.3001  FAILED, KNOWN, expected 14084.2807
    # test 8 DistanceVersaillesToEiffel: 14084.3001  FAILED, KNOWN, expected 14084.2807
    ...
    # 5 sphericalTrigonometry tests (17.2%) FAILED, incl. 5 KNOWN (Python 3.6.0)
...
# tests/run.py /usr/local/bin/python3 tests/testMgrs.py
    # all geodesy.mgrs tests passed (Python 3.6.0)
...
# tests/run.py /usr/local/bin/python3 tests/testNavlabExamples.py
    ...
    # 1 testNavlabExamples.py test (3.8%) FAILED, incl. 1 KNOWN (Python 3.6.0)
...
# tests/run.py /usr/local/bin/python3 tests/testOsgr.py
    ...
    # 6 geodesy.osgr tests (25.0%) FAILED, incl. 6 KNOWN (Python 3.6.0)

# tests/run.py /usr/local/bin/python3 tests/testSpherical.py
    # all sphericalNvector tests passed (Python 3.6.0)
    # all sphericalTrigonometry tests passed (Python 3.6.0)

# tests/run.py /usr/local/bin/python3 tests/testUtm.py
    # all geodesy.utm tests passed (Python 3.6.0)

# tests/run.py /usr/local/bin/python3 tests/tests.py
    # all tests.py tests passed (Python 3.6.0)

# tests/run.py /usr/local/bin/python3 all OK (Python 3.6.0)
