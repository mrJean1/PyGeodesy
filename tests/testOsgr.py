...
if __name__ == '__main__':
    ...
    class Tests(_Tests):
        ...
        def testOSgr(self):
            ...
            p.height = 0
            self.test('toLatLon1', p.toStr(F_DMS), '52°39′28.72″N, 001°42′57.74″E')
            self.test('toLatLon1', p, '52.657977°N, 001.716038°E')
            r = p.toOsgr()
            self.test('toOsgr1', r.toStr(0), '651409.903, 313177.270')

            p = g.toLatLon(eN.LatLon, datum=Datums.OSGB36)
            self.test('toLatLon2', p.toStr(F_DMS), '52°39′27.25″N, 001°43′04.47″E')
            self.test('toLatLon2', p, '52.657568°N, 001.717908°E')
            r = osgr.toOsgr(p)
            self.test('toOsgr2', r.toStr(0), '651409,313177')
    ...
    # testing geodesy.osgr version 16.10.14
    ...
    # test 6 toLatLon1: 52°39′28.72″N, 001°43′00.63″E  FAILED, expected 52°39′28.72″N, 001°42′57.74″E
    # test 7 toLatLon1: 52.657979°N, 001.716843°E  FAILED, expected 52.657977°N, 001.716038°E
    # test 8 toOsgr1: 651463,313180  FAILED, expected 651409.903, 313177.270
    # test 9 toLatLon2: 52°39′27.25″N, 001°43′07.37″E  FAILED, expected 52°39′27.25″N, 001°43′04.47″E
    # test 10 toLatLon2: 52.65757°N, 001.718713°E  FAILED, expected 52.657568°N, 001.717908°E
    # test 11 toOsgr2: 651463,313180  FAILED, expected 651409,313177
    ...
    # 6 geodesy.osgr tests (25.0%) FAILED (Python 2.7.10)
    ...
    # test 23 OSGR5: [OSGR:651409.000,313177.000]
    # test 24 OSGR6: 651409,313177
    # 6 geodesy.osgr tests (25.0%) FAILED (Python 3.5.1)
