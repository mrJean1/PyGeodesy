...
#   t.testLatLon(N.LatLon)
    ...
    # testing geodesy.ellipsoidalVincenty version 16.10.20
    # test 1 distanceTo (WGS84): 866455.43292
    # test 2 VincentyError (WGS84): LatLon(41°29′24.29″N, 071°18′46.07″W) coincident with LatLon(41°29′24.29″N, 071°18′46.07″W)  FAILED, expected LatLon(41.49008°N, 071.312796°W) coincident with LatLon(41.49008°N, 071.312796°W)
    ...
    # test 11 VincentyError (NAD83): LatLon(41°29′24.29″N, 071°18′46.07″W) coincident with LatLon(41°29′24.29″N, 071°18′46.07″W)  FAILED, expected LatLon(41.49008°N, 071.312796°W) coincident with LatLon(41.49008°N, 071.312796°W)
    ...
    # 2 geodesy.ellipsoidalVincenty tests (11.1%) FAILED (Python 2.7.10)
    ...
    # testing ellipsoidalVincenty version 16.10.20
    # test 1 distanceTo (WGS84): 866455.43292
    # test 2 VincentyError (WGS84): LatLon(41°29′24.29″N, 071°18′46.07″W) coincident with LatLon(41°29′24.29″N, 071°18′46.07″W)  FAILED, expected LatLon(41.49008°N, 071.312796°W) coincident with LatLon(41.49008°N, 071.312796°W)
    # test 3 ValueError (WGS84): other Ellipsoid mistmatch: Ellipsoids.Airy1830 vs Ellipsoids.WGS84
    # test 4 distanceTo (WGS84): 969954.1663
    ...
    # test 17 distanceTo3 (NAD83): 54973.29527, 126.86992, 127.17539
    # test 18 destination2 (NAD83): 37.652818°S, 143.926498°E, 307.1736°NW
    # 2 ellipsoidalVincenty tests (11.1%) FAILED (Python 3.5.2)
