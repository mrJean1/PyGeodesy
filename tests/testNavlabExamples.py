...
# Example 10: Cross track distance
    ...
    # test 17 Example 6 intermediateTo: 89.8°N, 180.0°E  FAILED, expected 89.799981°N, 180.0°E
    # test 18 Example 6 intermediateTo: 51.372084°N, 000.707337°E  FAILED, expected 51.372294°N, 000.707192°E
    ...
    # 3 testNavlabExamples.py tests (12.5%) FAILED (Python 2.7.10)
    ...
    # test 23 Example 9 intersection: 40.318643°N, 055.901868°E
    # test 24 Example 10 crossTrackDistance: 11118
    # 3 testNavlabExamples.py tests (12.5%) FAILED (Python 3.5.2)
