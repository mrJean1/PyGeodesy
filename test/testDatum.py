...
#       print(Datum())
        ...
        t = (E.toStr(prec=10),
            ...
            'AlphaKs=(%s)' % (fStr(E.AlphaKs, prec=12, fmt='%.*e', ints=True),),
            'BetaKs=(%s)'  % (fStr(E.BetaKs,  prec=12, fmt='%.*e', ints=True),))
        ...
        self.test('WGS84', t[2], "AlphaKs=(0, 8.377318206245e-04, 7.608527773572e-07, 1.197645503242e-09, 2.429170680397e-12, 5.711818370428e-15, 1.479997931380e-17, 4.107624109371e-2, 1.210785038923e-22)")
        self.test('WGS84', t[3], "BetaKs=(0, 8.377321640579e-04, 5.905870152220e-08, 1.673482665344e-1, 2.164798110491e-13, 3.787930968626e-16, 7.236769021816e-19, 1.493479824778e-21, 3.259522545838e-24)")
