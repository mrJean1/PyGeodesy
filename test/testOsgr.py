...
class Tests(TestsBase):
    ...
    def testOSgr(self, module):
        ...
        self.test('toOsgr1', r.toStr(prec=3, GD=False), '651409899,313177269', known=True)
        ...
        self.test('toLatLon4', t, '(52.657569999, 1.717909996, ', known=startswith)
        ...
        self.test('toLatLon4', t, '(52.657978295, 1.716040363, ', known=startswith)
